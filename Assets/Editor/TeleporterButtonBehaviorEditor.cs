...
[CustomEditor(typeof(TeleporterButtonBehavior),true)]
public class TeleporterButtonBehaviorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("teleporterVolumes"));
